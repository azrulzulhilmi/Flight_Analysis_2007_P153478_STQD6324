...
This project analyzes the 2007 U.S. Airline On-Time Performance dataset using Apache Hive SQL on Hadoop and Python for data visualization. The goal is to uncover patterns in flight delays and cancellations, identify major contributing factors, and highlight problematic routes, airlines, and airports.
